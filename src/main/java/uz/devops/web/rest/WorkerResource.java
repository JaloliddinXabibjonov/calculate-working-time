...
import uz.devops.service.WorkerQueryService;
...
/**
 * REST controller for managing {@link uz.devops.domain.Worker}.
 */
@RestController
@RequestMapping("/api")
public class WorkerResource {
    ...
    public ResponseEntity<WorkerDTO> updateWorker(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, workerDTO.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<WorkerDTO> partialUpdateWorker(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, workerDTO.getId().toString())
        );
    }
